...
<div class="container" style="margin-top: 14em;margin-bottom: 5em">
<div class="text-center">

<h1 class="text-white" style="text-shadow: 2px 2px 5px #424242;">
...
<h5 class="text-white">
<span><img src="<?=RUTA_IMG_ICONOS;?>icon-reloj-24.png"></span>	
...
<div class="border-b pb-1">
<h5 class="text-white">
<span><img src="<?=RUTA_IMG_ICONOS;?>icon-telefono-24.png"></span>						
...
<div class="border-b pb-1">
<h5 class="text-white">
<span><img src="<?=RUTA_IMG_ICONOS;?>icon-email-24.png"></span>							
...
<a class="btn btn-success btn-sm mt-5" href="<?=LINK_QUIENES_SOMOS;?>" role="button">Leer más</a>
</div>
...
<div class="text-end">
<a class="btn btn-success btn-sm mt-5" href="<?=LINK_QUEES_DOLOR;?>" role="button">Leer más</a>
</div>
</div>							
</div>
...
<div class="card shadow card border-0 rounded-0">
...
<p class="text-secondary fs-5 fw-light" align="justify">
...
<div class="text-end">
<a class="btn btn-sm btn-success rounded-0" href="<?=LINK_DOLOR_CANCER;?>" role="button"><small> Leer más</small></a>    
</div>  
</div>
</div>
</div>
...
<button type="button" class="btn btn-sm btn-success rounded-0" style="float: right"> <small> Leer más</small> </button>     
</div>
</div>
</div>
...
<p class="text-secondary fs-5 fw-light" align="justify">
Dolor que se extiende a lo largo del nervio ciático, desde la espalda baja hasta una o ambas piernas.</p>
</div>
<button type="button" class="btn btn-sm btn-success rounded-0" style="float: right"> <small> Leer más</small> </button>          
</div>
</div>
...
<div class="text-end">
<a class="btn btn-sm btn-success rounded-0" href="<?=LINK_DOLOR_NEURALGIA_POSTHERPETICA;?>" role="button"><small> Leer más</small></a>    
</div>       
</div>
</div>
</div>
