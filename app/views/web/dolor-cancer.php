...
<div class="text-end">
<a class="btn btn-sm btn-success rounded-0" href="<?=LINK_DOLOR_CANCER_FRECUENCIA;?>" role="button"><small> Leer más</small></a>    
</div>  
</div>
</div>
...
<div class="text-end">
<a class="btn btn-sm btn-success rounded-0" href="<?=LINK_DOLOR_CANCER_CAUSAS;?>" role="button"><small> Leer más</small></a>    
</div>  
</div>
</div>
...
<div class="text-end">
<a class="btn btn-sm btn-success rounded-0" href="<?=LINK_DOLOR_CANCER_PREGUNTAS_MEDICO;?>" role="button"><small> Leer más</small></a>    
</div>  
</div>
</div>
...
<div class="text-end">
<a class="btn btn-sm btn-success rounded-0" href="<?=LINK_DOLOR_CANCER_SEGUIMIENTO_TRATAMIENTO_DOLOR;?>" role="button"><small> Leer más</small></a>    
</div>  
</div>
</div>
...
<div class="text-end">
<a class="btn btn-sm btn-success rounded-0" href="<?=LINK_DOLOR_CANCER_CINCO_PRIORIDADES;?>" role="button"><small> Leer más</small></a>    
</div>  
</div>
</div>
...
<div class="text-end">
<a class="btn btn-sm btn-success rounded-0" href="<?=LINK_DOLOR_CANCER_ENDOSCOPIA_PALIATIVA;?>" role="button"><small> Leer más</small></a>    
</div>  
</div>
</div>
